...
ActiveRecord::Schema.define(version: 20170301142718) do
  ...
  add_index "sections", ["teachers_id"], name: "index_sections_on_teachers_id"
  ...
  add_index "teachers", ["sections_id"], name: "index_teachers_on_sections_id"
